...
const envSchema = z.object({
  ...
  OPENAI_SUMMARY_TIMEOUT_MS: z.coerce.number().int().positive().default(45_000),
  ...
  AFTER_NOTE_LABEL_WINDOW_MINUTES: z.coerce.number().int().positive().default(10),
  ...
  SLOW_JOB_PROGRESS_MS: z.coerce.number().int().positive().default(30_000),
